"""add is_active column to datasets table

Revision ID: f3dabb3f5bd7
Revises: 
Create Date: 2025-04-27 08:53:57.885164
...
def upgrade() -> None:
    """Upgrade schema."""
    # Add is_active column to datasets table
    op.add_column('datasets', sa.Column('is_active', sa.Boolean(), nullable=False, server_default=sa.true(), comment="有効フラグ（UIでOn/Off切り替え可能）"))
